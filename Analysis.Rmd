...
prior = c(prior(normal(0,0.01), class = Intercept), ## THIS PRIOR SHOULD BE SOMETHING ELSE?
          prior(normal(0,0.01), class = b, coef = clusteringCoef),
          prior(normal(0,0.01), class = b, coef = pathLength),
          prior(normal(0,0.01), class = b, coef = outbreakSize ))
...
# M: WE WON'T NEED THIS SINCE WE HAVE THE ONE ABOVE, RIGHT?
# A: THAT'S RIGHT
```
